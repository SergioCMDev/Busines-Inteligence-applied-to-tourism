...
def obtener_porcentaje_del_grado_de_ocupación_por_apartamentos_en_ciudad_en_anio(Ciudad, Anio):
    """
...
def obtener_porcentaje_del_grado_de_ocupación_por_apartamentos_en_ciudad_en_anio_mensualmente dividido por meses(Ciudad, Anio):
    """
...
def obtener_porcentaje_del_grado_de_ocupación_por_apartamentos_en_ciudad_en_rango_anios(Ciudad, AnioInicio, AnioFin):
    """
...
def obtener_porcentaje_del_grado_de_ocupación_por_apartamentos_en_ciudad_en_rango_anios_en_mes(Ciudad, AnioInicio, AnioFin, Mes):
    """
