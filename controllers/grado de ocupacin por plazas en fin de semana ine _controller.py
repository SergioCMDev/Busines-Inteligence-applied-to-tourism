...
def obtener_grado_de_ocupación_por_plazas_en_fin_de_semana_en_ciudad_en_anio(Ciudad, Anio):
    """
...
def obtener_grado_de_ocupación_por_plazas_en_fin_de_semana_en_ciudad_en_anio_mensualmente dividido por meses(Ciudad, Anio):
    """
...
def obtener_grado_de_ocupación_por_plazas_en_fin_de_semana_en_ciudad_en_rango_anios(Ciudad, AnioInicio, AnioFin):
    """
...
def obtener_grado_de_ocupación_por_plazas_en_fin_de_semana_en_ciudad_en_rango_anios_en_mes(Ciudad, AnioInicio, AnioFin, Mes):
    """
