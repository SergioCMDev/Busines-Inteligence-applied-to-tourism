...
def obtener_cantidad_total_personal_empleado_en_ciudad_en_rango_anios_mensualmente(Ciudad, AnioInicio, AnioFin):
    """
    Dado una ciudad y un rango de años obtiene la cantidad total de personas empleadas en dicha ciudad en esos años mensualmente
    Dado una ciudad y un rango de años obtiene la cantidad total de personas empleadas en dicha ciudad en esos años mensualmente
    :param Ciudad: Ciudad
    :type Ciudad: str
    :param AnioInicio: Anio Inicio
