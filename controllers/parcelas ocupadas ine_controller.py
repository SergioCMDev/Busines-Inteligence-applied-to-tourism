...
def obtener_cantidad_de_parcelas_ocupadas_en_ciudad_en_rango_anios_mensualmente(Ciudad, AnioInicio, AnioFin):
    """
    Dado una ciudad y un rango de años obtiene la cantidad de parcelas ocupadas en dicha ciudad en esos años mensualmente
    Dado una ciudad y un rango de años obtiene la cantidad de parcelas ocupadas en dicha ciudad en esos años mensualmente
    :param Ciudad: Ciudad
    :type Ciudad: str
    :param AnioInicio: Anio Inicio
    ...
    cursor, labels = repository.ObtenerNumeroTotalParcelasOcupadasEnCiudadEnRangoAniosMensualmente(Ciudad, AnioInicio, AnioFin)
